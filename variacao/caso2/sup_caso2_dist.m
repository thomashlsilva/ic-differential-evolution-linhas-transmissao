...
xr = [-9.478 -9.25 -0.228 0 9.022 9.25];
...
xr1 = [-8.478 -8.25 -0.228 0 8.022 8.25];
yr1 = [14.290 14.290 14.290 14.290 14.290 14.290];
yi1 = -yr1;
...
%% Cálculo das posições em y1 das cargas imagens
...
E1_xr17 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(1,7))./((xf1 - posx1(1,7)).^2 + (yf1 - posy1(1,7)).^2));
E1_xr18 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(1,8))./((xf1 - posx1(1,8)).^2 + (yf1 - posy1(1,8)).^2));
E1_xr19 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(1,9))./((xf1 - posx1(1,9)).^2 + (yf1 - posy1(1,9)).^2));
E1_xr110 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(1,10))./((xf1 - posx1(1,10)).^2 + (yf1 - posy1(1,10)).^2));
E1_xr1_11 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(1,11))./((xf1 - posx1(1,11)).^2 + (yf1 - posy1(1,11)).^2));
E1_xr1_12 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(1,12))./((xf1 - posx1(1,12)).^2 + (yf1 - posy1(1,12)).^2));
...
E1_xr27 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(2,7))./((xf1 - posx1(2,7)).^2 + (yf1 - posy1(2,7)).^2));
E1_xr28 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(2,8))./((xf1 - posx1(2,8)).^2 + (yf1 - posy1(2,8)).^2));
E1_xr29 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(2,9))./((xf1 - posx1(2,9)).^2 + (yf1 - posy1(2,9)).^2));
E1_xr210 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(2,10))./((xf1 - posx1(2,10)).^2 + (yf1 - posy1(2,10)).^2));
E1_xr2_11 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(2,11))./((xf1 - posx1(2,11)).^2 + (yf1 - posy1(2,11)).^2));
E1_xr2_12 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(2,12))./((xf1 - posx1(2,12)).^2 + (yf1 - posy1(2,12)).^2));
...
E1_xr37 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(3,7))./((xf1 - posx1(3,7)).^2 + (yf1 - posy1(3,7)).^2));
E1_xr38 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(3,8))./((xf1 - posx1(3,8)).^2 + (yf1 - posy1(3,8)).^2));
E1_xr39 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(3,9))./((xf1 - posx1(3,9)).^2 + (yf1 - posy1(3,9)).^2));
E1_xr310 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(3,10))./((xf1 - posx1(3,10)).^2 + (yf1 - posy1(3,10)).^2));
E1_xr311 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(3,11))./((xf1 - posx1(3,11)).^2 + (yf1 - posy1(3,11)).^2));
E1_xr312 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(3,12))./((xf1 - posx1(3,12)).^2 + (yf1 - posy1(3,12)).^2));
...
E1_xr47 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(4,7))./((xf1 - posx1(4,7)).^2 + (yf1 - posy1(4,7)).^2));
E1_xr48 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(4,8))./((xf1 - posx1(4,8)).^2 + (yf1 - posy1(4,8)).^2));
E1_xr49 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(4,9))./((xf1 - posx1(4,9)).^2 + (yf1 - posy1(4,9)).^2));
E1_xr410 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(4,10))./((xf1 - posx1(4,10)).^2 + (yf1 - posy1(4,10)).^2));
E1_xr411 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(4,11))./((xf1 - posx1(4,11)).^2 + (yf1 - posy1(4,11)).^2));
E1_xr412 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(4,12))./((xf1 - posx1(4,12)).^2 + (yf1 - posy1(4,12)).^2));
...
E1_xr57 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(5,7))./((xf1 - posx1(5,7)).^2 + (yf1 - posy1(5,7)).^2));
E1_xr58 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(5,8))./((xf1 - posx1(5,8)).^2 + (yf1 - posy1(5,8)).^2));
E1_xr59 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(5,9))./((xf1 - posx1(5,9)).^2 + (yf1 - posy1(5,9)).^2));
E1_xr510 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(5,10))./((xf1 - posx1(5,10)).^2 + (yf1 - posy1(5,10)).^2));
E1_xr511 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(5,11))./((xf1 - posx1(5,11)).^2 + (yf1 - posy1(5,11)).^2));
E1_xr512 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(5,12))./((xf1 - posx1(5,12)).^2 + (yf1 - posy1(5,12)).^2));
...
E1_xr67 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(6,7))./((xf1 - posx1(6,7)).^2 + (yf1 - posy1(6,7)).^2));
E1_xr68 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(6,8))./((xf1 - posx1(6,8)).^2 + (yf1 - posy1(6,8)).^2));
E1_xr69 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(6,9))./((xf1 - posx1(6,9)).^2 + (yf1 - posy1(6,9)).^2));
E1_xr610 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(6,10))./((xf1 - posx1(6,10)).^2 + (yf1 - posy1(6,10)).^2));
E1_xr611 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(6,11))./((xf1 - posx1(6,11)).^2 + (yf1 - posy1(6,11)).^2));
E1_xr612 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(6,12))./((xf1 - posx1(6,12)).^2 + (yf1 - posy1(6,12)).^2));
...
E1_xr78 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(7,8))./((xf1 - posx1(7,8)).^2 + (yf1 - posy1(7,8)).^2));
E1_xr79 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(7,9))./((xf1 - posx1(7,9)).^2 + (yf1 - posy1(7,9)).^2));
E1_xr710 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(7,10))./((xf1 - posx1(7,10)).^2 + (yf1 - posy1(7,10)).^2));
E1_xr711 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(7,11))./((xf1 - posx1(7,11)).^2 + (yf1 - posy1(7,11)).^2));
E1_xr712 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(7,12))./((xf1 - posx1(7,12)).^2 + (yf1 - posy1(7,12)).^2));
...
E1_xr87 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(8,7))./((xf1 - posx1(8,7)).^2 + (yf1 - posy1(8,7)).^2));
E1_xr89 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(8,9))./((xf1 - posx1(8,9)).^2 + (yf1 - posy1(8,9)).^2));
E1_xr810 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(8,10))./((xf1 - posx1(8,10)).^2 + (yf1 - posy1(8,10)).^2));
E1_xr811 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(8,11))./((xf1 - posx1(8,11)).^2 + (yf1 - posy1(8,11)).^2));
E1_xr812 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(8,12))./((xf1 - posx1(8,12)).^2 + (yf1 - posy1(8,12)).^2));
...
E1_xr97 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(9,7))./((xf1 - posx1(9,7)).^2 + (yf1 - posy1(9,7)).^2));
E1_xr98 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(9,8))./((xf1 - posx1(9,8)).^2 + (yf1 - posy1(9,8)).^2));
E1_xr910 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(9,10))./((xf1 - posx1(9,10)).^2 + (yf1 - posy1(9,10)).^2));
E1_xr911 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(9,11))./((xf1 - posx1(9,11)).^2 + (yf1 - posy1(9,11)).^2));
E1_xr912 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(9,12))./((xf1 - posx1(9,12)).^2 + (yf1 - posy1(9,12)).^2));
...
E1_xr107 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(10,7))./((xf1 - posx1(10,7)).^2 + (yf1 - posy1(10,7)).^2));
E1_xr108 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(10,8))./((xf1 - posx1(10,8)).^2 + (yf1 - posy1(10,8)).^2));
E1_xr109 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(10,9))./((xf1 - posx1(10,9)).^2 + (yf1 - posy1(10,9)).^2));
E1_xr1011 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(10,11))./((xf1 - posx1(10,11)).^2 + (yf1 - posy1(10,11)).^2));
E1_xr1012 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(10,12))./((xf1 - posx1(10,12)).^2 + (yf1 - posy1(10,12)).^2));
...
E1_xr117 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(11,7))./((xf1 - posx1(11,7)).^2 + (yf1 - posy1(11,7)).^2));
E1_xr118 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(11,8))./((xf1 - posx1(11,8)).^2 + (yf1 - posy1(11,8)).^2));
E1_xr119 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(11,9))./((xf1 - posx1(11,9)).^2 + (yf1 - posy1(11,9)).^2));
E1_xr1110 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(11,10))./((xf1 - posx1(11,10)).^2 + (yf1 - posy1(11,10)).^2));
E1_xr1112 = (rho1_r6/(2*pi*e_0)).*((xf1 - posx1(11,12))./((xf1 - posx1(11,12)).^2 + (yf1 - posy1(11,12)).^2));
...
E1_xr127 = (rho1_r1/(2*pi*e_0)).*((xf1 - posx1(12,7))./((xf1 - posx1(12,7)).^2 + (yf1 - posy1(12,7)).^2));
E1_xr128 = (rho1_r2/(2*pi*e_0)).*((xf1 - posx1(12,8))./((xf1 - posx1(12,8)).^2 + (yf1 - posy1(12,8)).^2));
E1_xr129 = (rho1_r3/(2*pi*e_0)).*((xf1 - posx1(12,9))./((xf1 - posx1(12,9)).^2 + (yf1 - posy1(12,9)).^2));
E1_xr1210 = (rho1_r4/(2*pi*e_0)).*((xf1 - posx1(12,10))./((xf1 - posx1(12,10)).^2 + (yf1 - posy1(12,10)).^2));
E1_xr1211 = (rho1_r5/(2*pi*e_0)).*((xf1 - posx1(12,11))./((xf1 - posx1(12,11)).^2 + (yf1 - posy1(12,11)).^2));
...
E1_xi17 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(1,7))./((xf1 - posx1(1,7)).^2 + (yf1 - posy1(1,7)).^2));
E1_xi18 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(1,8))./((xf1 - posx1(1,8)).^2 + (yf1 - posy1(1,8)).^2));
E1_xi19 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(1,9))./((xf1 - posx1(1,9)).^2 + (yf1 - posy1(1,9)).^2));
E1_xi110 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(1,10))./((xf1 - posx1(1,10)).^2 + (yf1 - posy1(1,10)).^2));
E1_xi1_11 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(1,11))./((xf1 - posx1(1,11)).^2 + (yf1 - posy1(1,11)).^2));
E1_xi1_12 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(1,12))./((xf1 - posx1(1,12)).^2 + (yf1 - posy1(1,12)).^2));
...
E1_xi27 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(2,7))./((xf1 - posx1(2,7)).^2 + (yf1 - posy1(2,7)).^2));
E1_xi28 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(2,8))./((xf1 - posx1(2,8)).^2 + (yf1 - posy1(2,8)).^2));
E1_xi29 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(2,9))./((xf1 - posx1(2,9)).^2 + (yf1 - posy1(2,9)).^2));
E1_xi210 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(2,10))./((xf1 - posx1(2,10)).^2 + (yf1 - posy1(2,10)).^2));
E1_xi2_11 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(2,11))./((xf1 - posx1(2,11)).^2 + (yf1 - posy1(2,11)).^2));
E1_xi2_12 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(2,12))./((xf1 - posx1(2,12)).^2 + (yf1 - posy1(2,12)).^2));
...
E1_xi37 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(3,7))./((xf1 - posx1(3,7)).^2 + (yf1 - posy1(3,7)).^2));
E1_xi38 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(3,8))./((xf1 - posx1(3,8)).^2 + (yf1 - posy1(3,8)).^2));
E1_xi39 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(3,9))./((xf1 - posx1(3,9)).^2 + (yf1 - posy1(3,9)).^2));
E1_xi310 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(3,10))./((xf1 - posx1(3,10)).^2 + (yf1 - posy1(3,10)).^2));
E1_xi311 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(3,11))./((xf1 - posx1(3,11)).^2 + (yf1 - posy1(3,11)).^2));
E1_xi312 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(3,12))./((xf1 - posx1(3,12)).^2 + (yf1 - posy1(3,12)).^2));
...
E1_xi47 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(4,7))./((xf1 - posx1(4,7)).^2 + (yf1 - posy1(4,7)).^2));
E1_xi48 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(4,8))./((xf1 - posx1(4,8)).^2 + (yf1 - posy1(4,8)).^2));
E1_xi49 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(4,9))./((xf1 - posx1(4,9)).^2 + (yf1 - posy1(4,9)).^2));
E1_xi410 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(4,10))./((xf1 - posx1(4,10)).^2 + (yf1 - posy1(4,10)).^2));
E1_xi411 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(4,11))./((xf1 - posx1(4,11)).^2 + (yf1 - posy1(4,11)).^2));
E1_xi412 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(4,12))./((xf1 - posx1(4,12)).^2 + (yf1 - posy1(4,12)).^2));
...
E1_xi57 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(5,7))./((xf1 - posx1(5,7)).^2 + (yf1 - posy1(5,7)).^2));
E1_xi58 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(5,8))./((xf1 - posx1(5,8)).^2 + (yf1 - posy1(5,8)).^2));
E1_xi59 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(5,9))./((xf1 - posx1(5,9)).^2 + (yf1 - posy1(5,9)).^2));
E1_xi510 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(5,10))./((xf1 - posx1(5,10)).^2 + (yf1 - posy1(5,10)).^2));
E1_xi511 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(5,11))./((xf1 - posx1(5,11)).^2 + (yf1 - posy1(5,11)).^2));
E1_xi512 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(5,12))./((xf1 - posx1(5,12)).^2 + (yf1 - posy1(5,12)).^2));
...
E1_xi67 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(6,7))./((xf1 - posx1(6,7)).^2 + (yf1 - posy1(6,7)).^2));
E1_xi68 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(6,8))./((xf1 - posx1(6,8)).^2 + (yf1 - posy1(6,8)).^2));
E1_xi69 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(6,9))./((xf1 - posx1(6,9)).^2 + (yf1 - posy1(6,9)).^2));
E1_xi610 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(6,10))./((xf1 - posx1(6,10)).^2 + (yf1 - posy1(6,10)).^2));
E1_xi611 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(6,11))./((xf1 - posx1(6,11)).^2 + (yf1 - posy1(6,11)).^2));
E1_xi612 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(6,12))./((xf1 - posx1(6,12)).^2 + (yf1 - posy1(6,12)).^2));
...
E1_xi78 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(7,8))./((xf1 - posx1(7,8)).^2 + (yf1 - posy1(7,8)).^2));
E1_xi79 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(7,9))./((xf1 - posx1(7,9)).^2 + (yf1 - posy1(7,9)).^2));
E1_xi710 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(7,10))./((xf1 - posx1(7,10)).^2 + (yf1 - posy1(7,10)).^2));
E1_xi711 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(7,11))./((xf1 - posx1(7,11)).^2 + (yf1 - posy1(7,11)).^2));
E1_xi712 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(7,12))./((xf1 - posx1(7,12)).^2 + (yf1 - posy1(7,12)).^2));
...
E1_xi87 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(8,7))./((xf1 - posx1(8,7)).^2 + (yf1 - posy1(8,7)).^2));
E1_xi89 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(8,9))./((xf1 - posx1(8,9)).^2 + (yf1 - posy1(8,9)).^2));
E1_xi810 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(8,10))./((xf1 - posx1(8,10)).^2 + (yf1 - posy1(8,10)).^2));
E1_xi811 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(8,11))./((xf1 - posx1(8,11)).^2 + (yf1 - posy1(8,11)).^2));
E1_xi812 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(8,12))./((xf1 - posx1(8,12)).^2 + (yf1 - posy1(8,12)).^2));
...
E1_xi97 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(9,7))./((xf1 - posx1(9,7)).^2 + (yf1 - posy1(9,7)).^2));
E1_xi98 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(9,8))./((xf1 - posx1(9,8)).^2 + (yf1 - posy1(9,8)).^2));
E1_xi910 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(9,10))./((xf1 - posx1(9,10)).^2 + (yf1 - posy1(9,10)).^2));
E1_xi911 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(9,11))./((xf1 - posx1(9,11)).^2 + (yf1 - posy1(9,11)).^2));
E1_xi912 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(9,12))./((xf1 - posx1(9,12)).^2 + (yf1 - posy1(9,12)).^2));
...
E1_xi107 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(10,7))./((xf1 - posx1(10,7)).^2 + (yf1 - posy1(10,7)).^2));
E1_xi108 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(10,8))./((xf1 - posx1(10,8)).^2 + (yf1 - posy1(10,8)).^2));
E1_xi109 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(10,9))./((xf1 - posx1(10,9)).^2 + (yf1 - posy1(10,9)).^2));
E1_xi1011 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(10,11))./((xf1 - posx1(10,11)).^2 + (yf1 - posy1(10,11)).^2));
E1_xi1012 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(10,12))./((xf1 - posx1(10,12)).^2 + (yf1 - posy1(10,12)).^2));
...
E1_xi117 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(11,7))./((xf1 - posx1(11,7)).^2 + (yf1 - posy1(11,7)).^2));
E1_xi118 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(11,8))./((xf1 - posx1(11,8)).^2 + (yf1 - posy1(11,8)).^2));
E1_xi119 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(11,9))./((xf1 - posx1(11,9)).^2 + (yf1 - posy1(11,9)).^2));
E1_xi1110 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(11,10))./((xf1 - posx1(11,10)).^2 + (yf1 - posy1(11,10)).^2));
E1_xi1112 = (rho1_i6/(2*pi*e_0)).*((xf1 - posx1(11,12))./((xf1 - posx1(11,12)).^2 + (yf1 - posy1(11,12)).^2));
...
E1_xi127 = (rho1_i1/(2*pi*e_0)).*((xf1 - posx1(12,7))./((xf1 - posx1(12,7)).^2 + (yf1 - posy1(12,7)).^2));
E1_xi128 = (rho1_i2/(2*pi*e_0)).*((xf1 - posx1(12,8))./((xf1 - posx1(12,8)).^2 + (yf1 - posy1(12,8)).^2));
E1_xi129 = (rho1_i3/(2*pi*e_0)).*((xf1 - posx1(12,9))./((xf1 - posx1(12,9)).^2 + (yf1 - posy1(12,9)).^2));
E1_xi1210 = (rho1_i4/(2*pi*e_0)).*((xf1 - posx1(12,10))./((xf1 - posx1(12,10)).^2 + (yf1 - posy1(12,10)).^2));
E1_xi1211 = (rho1_i5/(2*pi*e_0)).*((xf1 - posx1(12,11))./((xf1 - posx1(12,11)).^2 + (yf1 - posy1(12,11)).^2));
...
E1_yr17 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(1,7))./((xf1 - posx1(1,7)).^2 + (yf1 - posy1(1,7)).^2));
E1_yr18 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(1,8))./((xf1 - posx1(1,8)).^2 + (yf1 - posy1(1,8)).^2));
E1_yr19 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(1,9))./((xf1 - posx1(1,9)).^2 + (yf1 - posy1(1,9)).^2));
E1_yr110 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(1,10))./((xf1 - posx1(1,10)).^2 + (yf1 - posy1(1,10)).^2));
E1_yr1_11 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(1,11))./((xf1 - posx1(1,11)).^2 + (yf1 - posy1(1,11)).^2));
E1_yr1_12 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(1,12))./((xf1 - posx1(1,12)).^2 + (yf1 - posy1(1,12)).^2));
...
E1_yr27 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(2,7))./((xf1 - posx1(2,7)).^2 + (yf1 - posy1(2,7)).^2));
E1_yr28 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(2,8))./((xf1 - posx1(2,8)).^2 + (yf1 - posy1(2,8)).^2));
E1_yr29 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(2,9))./((xf1 - posx1(2,9)).^2 + (yf1 - posy1(2,9)).^2));
E1_yr210 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(2,10))./((xf1 - posx1(2,10)).^2 + (yf1 - posy1(2,10)).^2));
E1_yr2_11 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(2,11))./((xf1 - posx1(2,11)).^2 + (yf1 - posy1(2,11)).^2));
E1_yr2_12 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(2,12))./((xf1 - posx1(2,12)).^2 + (yf1 - posy1(2,12)).^2));
...
E1_yr37 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(3,7))./((xf1 - posx1(3,7)).^2 + (yf1 - posy1(3,7)).^2));
E1_yr38 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(3,8))./((xf1 - posx1(3,8)).^2 + (yf1 - posy1(3,8)).^2));
E1_yr39 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(3,9))./((xf1 - posx1(3,9)).^2 + (yf1 - posy1(3,9)).^2));
E1_yr310 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(3,10))./((xf1 - posx1(3,10)).^2 + (yf1 - posy1(3,10)).^2));
E1_yr311 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(3,11))./((xf1 - posx1(3,11)).^2 + (yf1 - posy1(3,11)).^2));
E1_yr312 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(3,12))./((xf1 - posx1(3,12)).^2 + (yf1 - posy1(3,12)).^2));
...
E1_yr47 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(4,7))./((xf1 - posx1(4,7)).^2 + (yf1 - posy1(4,7)).^2));
E1_yr48 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(4,8))./((xf1 - posx1(4,8)).^2 + (yf1 - posy1(4,8)).^2));
E1_yr49 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(4,9))./((xf1 - posx1(4,9)).^2 + (yf1 - posy1(4,9)).^2));
E1_yr410 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(4,10))./((xf1 - posx1(4,10)).^2 + (yf1 - posy1(4,10)).^2));
E1_yr411 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(4,11))./((xf1 - posx1(4,11)).^2 + (yf1 - posy1(4,11)).^2));
E1_yr412 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(4,12))./((xf1 - posx1(4,12)).^2 + (yf1 - posy1(4,12)).^2));
...
E1_yr57 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(5,7))./((xf1 - posx1(5,7)).^2 + (yf1 - posy1(5,7)).^2));
E1_yr58 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(5,8))./((xf1 - posx1(5,8)).^2 + (yf1 - posy1(5,8)).^2));
E1_yr59 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(5,9))./((xf1 - posx1(5,9)).^2 + (yf1 - posy1(5,9)).^2));
E1_yr510 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(5,10))./((xf1 - posx1(5,10)).^2 + (yf1 - posy1(5,10)).^2));
E1_yr511 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(5,11))./((xf1 - posx1(5,11)).^2 + (yf1 - posy1(5,11)).^2));
E1_yr512 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(5,12))./((xf1 - posx1(5,12)).^2 + (yf1 - posy1(5,12)).^2));
...
E1_yr67 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(6,7))./((xf1 - posx1(6,7)).^2 + (yf1 - posy1(6,7)).^2));
E1_yr68 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(6,8))./((xf1 - posx1(6,8)).^2 + (yf1 - posy1(6,8)).^2));
E1_yr69 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(6,9))./((xf1 - posx1(6,9)).^2 + (yf1 - posy1(6,9)).^2));
E1_yr610 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(6,10))./((xf1 - posx1(6,10)).^2 + (yf1 - posy1(6,10)).^2));
E1_yr611 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(6,11))./((xf1 - posx1(6,11)).^2 + (yf1 - posy1(6,11)).^2));
E1_yr612 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(6,12))./((xf1 - posx1(6,12)).^2 + (yf1 - posy1(6,12)).^2));
...
E1_yr78 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(7,8))./((xf1 - posx1(7,8)).^2 + (yf1 - posy1(7,8)).^2));
E1_yr79 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(7,9))./((xf1 - posx1(7,9)).^2 + (yf1 - posy1(7,9)).^2));
E1_yr710 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(7,10))./((xf1 - posx1(7,10)).^2 + (yf1 - posy1(7,10)).^2));
E1_yr711 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(7,11))./((xf1 - posx1(7,11)).^2 + (yf1 - posy1(7,11)).^2));
E1_yr712 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(7,12))./((xf1 - posx1(7,12)).^2 + (yf1 - posy1(7,12)).^2));
...
E1_yr87 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(8,7))./((xf1 - posx1(8,7)).^2 + (yf1 - posy1(8,7)).^2));
E1_yr89 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(8,9))./((xf1 - posx1(8,9)).^2 + (yf1 - posy1(8,9)).^2));
E1_yr810 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(8,10))./((xf1 - posx1(8,10)).^2 + (yf1 - posy1(8,10)).^2));
E1_yr811 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(8,11))./((xf1 - posx1(8,11)).^2 + (yf1 - posy1(8,11)).^2));
E1_yr812 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(8,12))./((xf1 - posx1(8,12)).^2 + (yf1 - posy1(8,12)).^2));
...
E1_yr97 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(9,7))./((xf1 - posx1(9,7)).^2 + (yf1 - posy1(9,7)).^2));
E1_yr98 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(9,8))./((xf1 - posx1(9,8)).^2 + (yf1 - posy1(9,8)).^2));
E1_yr910 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(9,10))./((xf1 - posx1(9,10)).^2 + (yf1 - posy1(9,10)).^2));
E1_yr911 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(9,11))./((xf1 - posx1(9,11)).^2 + (yf1 - posy1(9,11)).^2));
E1_yr912 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(9,12))./((xf1 - posx1(9,12)).^2 + (yf1 - posy1(9,12)).^2));
...
E1_yr107 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(10,7))./((xf1 - posx1(10,7)).^2 + (yf1 - posy1(10,7)).^2));
E1_yr108 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(10,8))./((xf1 - posx1(10,8)).^2 + (yf1 - posy1(10,8)).^2));
E1_yr109 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(10,9))./((xf1 - posx1(10,9)).^2 + (yf1 - posy1(10,9)).^2));
E1_yr1011 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(10,11))./((xf1 - posx1(10,11)).^2 + (yf1 - posy1(10,11)).^2));
E1_yr1012 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(10,12))./((xf1 - posx1(10,12)).^2 + (yf1 - posy1(10,12)).^2));
...
E1_yr117 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(11,7))./((xf1 - posx1(11,7)).^2 + (yf1 - posy1(11,7)).^2));
E1_yr118 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(11,8))./((xf1 - posx1(11,8)).^2 + (yf1 - posy1(11,8)).^2));
E1_yr119 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(11,9))./((xf1 - posx1(11,9)).^2 + (yf1 - posy1(11,9)).^2));
E1_yr1110 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(11,10))./((xf1 - posx1(11,10)).^2 + (yf1 - posy1(11,10)).^2));
E1_yr1112 = (rho1_r6/(2*pi*e_0)).*((yf1 - posy1(11,12))./((xf1 - posx1(11,12)).^2 + (yf1 - posy1(11,12)).^2));
...
E1_yr127 = (rho1_r1/(2*pi*e_0)).*((yf1 - posy1(12,7))./((xf1 - posx1(12,7)).^2 + (yf1 - posy1(12,7)).^2));
E1_yr128 = (rho1_r2/(2*pi*e_0)).*((yf1 - posy1(12,8))./((xf1 - posx1(12,8)).^2 + (yf1 - posy1(12,8)).^2));
E1_yr129 = (rho1_r3/(2*pi*e_0)).*((yf1 - posy1(12,9))./((xf1 - posx1(12,9)).^2 + (yf1 - posy1(12,9)).^2));
E1_yr1210 = (rho1_r4/(2*pi*e_0)).*((yf1 - posy1(12,10))./((xf1 - posx1(12,10)).^2 + (yf1 - posy1(12,10)).^2));
E1_yr1211 = (rho1_r5/(2*pi*e_0)).*((yf1 - posy1(12,11))./((xf1 - posx1(12,11)).^2 + (yf1 - posy1(12,11)).^2));
...
E1_yi17 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(1,7))./((xf1 - posx1(1,7)).^2 + (yf1 - posy1(1,7)).^2));
E1_yi18 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(1,8))./((xf1 - posx1(1,8)).^2 + (yf1 - posy1(1,8)).^2));
E1_yi19 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(1,9))./((xf1 - posx1(1,9)).^2 + (yf1 - posy1(1,9)).^2));
E1_yi110 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(1,10))./((xf1 - posx1(1,10)).^2 + (yf1 - posy1(1,10)).^2));
E1_yi1_11 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(1,11))./((xf1 - posx1(1,11)).^2 + (yf1 - posy1(1,11)).^2));
E1_yi1_12 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(1,12))./((xf1 - posx1(1,12)).^2 + (yf1 - posy1(1,12)).^2));
...
E1_yi27 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(2,7))./((xf1 - posx1(2,7)).^2 + (yf1 - posy1(2,7)).^2));
E1_yi28 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(2,8))./((xf1 - posx1(2,8)).^2 + (yf1 - posy1(2,8)).^2));
E1_yi29 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(2,9))./((xf1 - posx1(2,9)).^2 + (yf1 - posy1(2,9)).^2));
E1_yi210 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(2,10))./((xf1 - posx1(2,10)).^2 + (yf1 - posy1(2,10)).^2));
E1_yi2_11 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(2,11))./((xf1 - posx1(2,11)).^2 + (yf1 - posy1(2,11)).^2));
E1_yi2_12 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(2,12))./((xf1 - posx1(2,12)).^2 + (yf1 - posy1(2,12)).^2));
...
E1_yi37 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(3,7))./((xf1 - posx1(3,7)).^2 + (yf1 - posy1(3,7)).^2));
E1_yi38 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(3,8))./((xf1 - posx1(3,8)).^2 + (yf1 - posy1(3,8)).^2));
E1_yi39 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(3,9))./((xf1 - posx1(3,9)).^2 + (yf1 - posy1(3,9)).^2));
E1_yi310 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(3,10))./((xf1 - posx1(3,10)).^2 + (yf1 - posy1(3,10)).^2));
E1_yi311 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(3,11))./((xf1 - posx1(3,11)).^2 + (yf1 - posy1(3,11)).^2));
E1_yi312 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(3,12))./((xf1 - posx1(3,12)).^2 + (yf1 - posy1(3,12)).^2));
...
E1_yi47 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(4,7))./((xf1 - posx1(4,7)).^2 + (yf1 - posy1(4,7)).^2));
E1_yi48 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(4,8))./((xf1 - posx1(4,8)).^2 + (yf1 - posy1(4,8)).^2));
E1_yi49 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(4,9))./((xf1 - posx1(4,9)).^2 + (yf1 - posy1(4,9)).^2));
E1_yi410 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(4,10))./((xf1 - posx1(4,10)).^2 + (yf1 - posy1(4,10)).^2));
E1_yi411 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(4,11))./((xf1 - posx1(4,11)).^2 + (yf1 - posy1(4,11)).^2));
E1_yi412 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(4,12))./((xf1 - posx1(4,12)).^2 + (yf1 - posy1(4,12)).^2));
...
E1_yi57 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(5,7))./((xf1 - posx1(5,7)).^2 + (yf1 - posy1(5,7)).^2));
E1_yi58 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(5,8))./((xf1 - posx1(5,8)).^2 + (yf1 - posy1(5,8)).^2));
E1_yi59 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(5,9))./((xf1 - posx1(5,9)).^2 + (yf1 - posy1(5,9)).^2));
E1_yi510 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(5,10))./((xf1 - posx1(5,10)).^2 + (yf1 - posy1(5,10)).^2));
E1_yi511 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(5,11))./((xf1 - posx1(5,11)).^2 + (yf1 - posy1(5,11)).^2));
E1_yi512 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(5,12))./((xf1 - posx1(5,12)).^2 + (yf1 - posy1(5,12)).^2));
...
E1_yi67 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(6,7))./((xf1 - posx1(6,7)).^2 + (yf1 - posy1(6,7)).^2));
E1_yi68 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(6,8))./((xf1 - posx1(6,8)).^2 + (yf1 - posy1(6,8)).^2));
E1_yi69 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(6,9))./((xf1 - posx1(6,9)).^2 + (yf1 - posy1(6,9)).^2));
E1_yi610 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(6,10))./((xf1 - posx1(6,10)).^2 + (yf1 - posy1(6,10)).^2));
E1_yi611 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(6,11))./((xf1 - posx1(6,11)).^2 + (yf1 - posy1(6,11)).^2));
E1_yi612 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(6,12))./((xf1 - posx1(6,12)).^2 + (yf1 - posy1(6,12)).^2));
...
E1_yi78 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(7,8))./((xf1 - posx1(7,8)).^2 + (yf1 - posy1(7,8)).^2));
E1_yi79 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(7,9))./((xf1 - posx1(7,9)).^2 + (yf1 - posy1(7,9)).^2));
E1_yi710 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(7,10))./((xf1 - posx1(7,10)).^2 + (yf1 - posy1(7,10)).^2));
E1_yi711 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(7,11))./((xf1 - posx1(7,11)).^2 + (yf1 - posy1(7,11)).^2));
E1_yi712 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(7,12))./((xf1 - posx1(7,12)).^2 + (yf1 - posy1(7,12)).^2));
...
E1_yi87 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(8,7))./((xf1 - posx1(8,7)).^2 + (yf1 - posy1(8,7)).^2));
E1_yi89 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(8,9))./((xf1 - posx1(8,9)).^2 + (yf1 - posy1(8,9)).^2));
E1_yi810 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(8,10))./((xf1 - posx1(8,10)).^2 + (yf1 - posy1(8,10)).^2));
E1_yi811 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(8,11))./((xf1 - posx1(8,11)).^2 + (yf1 - posy1(8,11)).^2));
E1_yi812 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(8,12))./((xf1 - posx1(8,12)).^2 + (yf1 - posy1(8,12)).^2));
...
E1_yi97 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(9,7))./((xf1 - posx1(9,7)).^2 + (yf1 - posy1(9,7)).^2));
E1_yi98 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(9,8))./((xf1 - posx1(9,8)).^2 + (yf1 - posy1(9,8)).^2));
E1_yi910 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(9,10))./((xf1 - posx1(9,10)).^2 + (yf1 - posy1(9,10)).^2));
E1_yi911 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(9,11))./((xf1 - posx1(9,11)).^2 + (yf1 - posy1(9,11)).^2));
E1_yi912 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(9,12))./((xf1 - posx1(9,12)).^2 + (yf1 - posy1(9,12)).^2));
...
E1_yi107 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(10,7))./((xf1 - posx1(10,7)).^2 + (yf1 - posy1(10,7)).^2));
E1_yi108 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(10,8))./((xf1 - posx1(10,8)).^2 + (yf1 - posy1(10,8)).^2));
E1_yi109 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(10,9))./((xf1 - posx1(10,9)).^2 + (yf1 - posy1(10,9)).^2));
E1_yi1011 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(10,11))./((xf1 - posx1(10,11)).^2 + (yf1 - posy1(10,11)).^2));
E1_yi1012 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(10,12))./((xf1 - posx1(10,12)).^2 + (yf1 - posy1(10,12)).^2));
...
E1_yi117 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(11,7))./((xf1 - posx1(11,7)).^2 + (yf1 - posy1(11,7)).^2));
E1_yi118 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(11,8))./((xf1 - posx1(11,8)).^2 + (yf1 - posy1(11,8)).^2));
E1_yi119 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(11,9))./((xf1 - posx1(11,9)).^2 + (yf1 - posy1(11,9)).^2));
E1_yi1110 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(11,10))./((xf1 - posx1(11,10)).^2 + (yf1 - posy1(11,10)).^2));
E1_yi1112 = (rho1_i6/(2*pi*e_0)).*((yf1 - posy1(11,12))./((xf1 - posx1(11,12)).^2 + (yf1 - posy1(11,12)).^2));
...
E1_yi127 = (rho1_i1/(2*pi*e_0)).*((yf1 - posy1(12,7))./((xf1 - posx1(12,7)).^2 + (yf1 - posy1(12,7)).^2));
E1_yi128 = (rho1_i2/(2*pi*e_0)).*((yf1 - posy1(12,8))./((xf1 - posx1(12,8)).^2 + (yf1 - posy1(12,8)).^2));
E1_yi129 = (rho1_i3/(2*pi*e_0)).*((yf1 - posy1(12,9))./((xf1 - posx1(12,9)).^2 + (yf1 - posy1(12,9)).^2));
E1_yi1210 = (rho1_i4/(2*pi*e_0)).*((yf1 - posy1(12,10))./((xf1 - posx1(12,10)).^2 + (yf1 - posy1(12,10)).^2));
E1_yi1211 = (rho1_i5/(2*pi*e_0)).*((yf1 - posy1(12,11))./((xf1 - posx1(12,11)).^2 + (yf1 - posy1(12,11)).^2));

%% aqui em cada matriz dessa tem as componentes geradas na direção x e y, pela parte real e imaginária de cada carga elétrica:

E1_xr = [ E1_xr12 ; E1_xr13 ; E1_xr14 ; E1_xr15 ; E1_xr16 ; E1_xr17 ; E1_xr18 ; E1_xr19 ; E1_xr110 ; E1_xr1_11 ; E1_xr1_12 ; E1_xr21 ; E1_xr23 ; E1_xr24 ; E1_xr25 ; E1_xr26 ; E1_xr27 ; E1_xr28 ; E1_xr29 ; E1_xr210 ; E1_xr2_11 ; E1_xr2_12 ; E1_xr31 ; E1_xr32 ; E1_xr34 ; E1_xr35 ; E1_xr36 ; E1_xr37 ; E1_xr38 ; E1_xr39 ; E1_xr310 ; E1_xr311 ; E1_xr312 ; E1_xr41 ; E1_xr42 ; E1_xr43 ; E1_xr45 ; E1_xr46 ; E1_xr47 ; E1_xr48 ; E1_xr49 ; E1_xr410 ; E1