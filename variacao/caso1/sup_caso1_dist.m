...
x1 = [xr1 xr1]; % posição x dos condutores (com imagens)
y1 = [yr1 -yr1]; % posição y dos condutores (com imagens)

xcj1 = x1(3); % posição x do centro condutor (para trocar o condutor avaliado deve-se mudar este valor)
ycj1 = y1(3); % posição y do centro condutor

xf1 = r.*cos(theta) + xcj1; % eixo x do ponto de avaliação
yf1 = r.*sin(theta) + ycj1; % eixo y do ponto de avaliação
...
%% E1_xr componente x real campo elétrico condutor 2 fase b assim segue:
