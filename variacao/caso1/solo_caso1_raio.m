...
% RAIO MAIOR E MENOR da configuração original
...
r1 = 0.01376; % raio do condutor

x1 = [-3 0 3];
y1 = [14.01 14.01 14.01];
yi1 = -y1;
...
legend('Original','Raio maior', 'Raio menor', 'Limite da norma')
set(gca, 'YScale', 'log')
...
legend('Original','Raio maior', 'Raio menor')
xlim([-3.5 3.5])
ylim([11.5 16.5])
...
print(g,'solo_caso1_raio_config','-dpdf','-r0')